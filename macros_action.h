...
#define ACTION_N(act, sp, args, name) retvalue action_n_ ## act ## _ ## sp ## _ ## name ( \
...
#define ACTION_C(act, sp, name) retvalue action_c_ ## act ## _ ## sp ## _ ## name ( \
...
#define ACTION_B(act, sp, u, name) retvalue action_b_ ## act ## _ ## sp ## _ ## name ( \
...
#define ACTION_L(act, sp, u, args, name) retvalue action_l_ ## act ## _ ## sp ## _ ## name ( \
			struct distribution *alldistributions,       \
			sp(const char *, section),                   \
			sp(const char *, priority),                  \
			act(const struct atomlist *, architectures), \
...
#define ACTION_R(act, sp, d, a, name) retvalue action_r_ ## act ## _ ## sp ## _ ## name ( \
...
#define ACTION_T(act, sp, name) retvalue action_t_ ## act ## _ ## sp ## _ ## name ( \
...
#define ACTION_F(act, sp, d, a, name) retvalue action_f_ ## act ## _ ## sp ## _ ## name ( \
			d(struct distribution *, alldistributions),  \
			sp(const char *, section),                   \
			sp(const char *, priority),                  \
			act(const struct atomlist *, architectures), \
...
#define ACTION_RF(act, sp, ud, u, name) retvalue action_rf_ ## act ## _ ## sp ## _ ## name ( \
...
#define ACTION_D(act, sp, u, name) retvalue action_d_ ## act ## _ ## sp ## _ ## name ( \
			struct distribution *alldistributions,       \
			sp(const char *, section),                   \
			sp(const char *, priority),                  \
			act(const struct atomlist *, architectures), \
